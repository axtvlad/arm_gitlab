import {otherDocsAPI} from "../../api/otherDocAPI";
...
export const getOtherDocs = () => async (dispatch) => {
    ...
    const response = await otherDocsAPI.getOtherDocs()
